...
class Admin::ProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_project" do
    assert_difference("Admin::Project.count") do
      post admin_projects_url, params: { admin_project: { description: @admin_project.description, featured_image: @admin_project.featured_image, github_url: @admin_project.github_url, live_url: @admin_project.live_url, tags: @admin_project.tags, title: @admin_project.title } }
    end
  ...
  test "should update admin_project" do
    patch admin_project_url(@admin_project), params: { admin_project: { description: @admin_project.description, featured_image: @admin_project.featured_image, github_url: @admin_project.github_url, live_url: @admin_project.live_url, tags: @admin_project.tags, title: @admin_project.title } }
